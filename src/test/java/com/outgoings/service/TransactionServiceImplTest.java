...
class TransactionServiceImplTest {
  ...
  void addTransaction_shouldSaveTransaction() {
    ...
    Mockito.when(transactionRepository.findByAccount(account)).thenReturn(new ArrayList<>());
  ...
  void clearTransactions_shouldHandleEmptyList() {
    Account account = new Account();
    Mockito.when(transactionRepository.findByAccount(account)).thenReturn(Collections.emptyList());
